...
It covers Appendices A, B and C, together with Definition 6 and Theorem 4
...
this formalization. In particular, Lemma 6 is formalized here, but the
main-text accumulation theorem that applies it is not. The two expository
remarks following Lemma 10 are also outside the scope.
